...
function isPrizeAward(value: unknown): value is PrizeAward {
  ...
  return (
    ...
    Number.isFinite(Date.parse(award.selectedAt)) &&
    (award.deliveredAt === null ||
      (typeof award.deliveredAt === "string" &&
        Number.isFinite(Date.parse(award.deliveredAt))))
  )
}
